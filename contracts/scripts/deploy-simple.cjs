// Deploy script - CommonJS format per Hardhat
...
async function main() {
    ...
    // 4. RMRKCreature (grande, potrebbe fallire)
    ...
    try {
        ...
        console.log("  RMRKCreature deploy failed (too large). Economy contracts deployed without it.");
        addresses.RMRKCreature = "DEPLOY_FAILED";
    }
